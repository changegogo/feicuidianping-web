...
<body data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/SearchServer/WebRoot/index.jsp">
	<div class="box" data-genuitec-lp-enabled="false" data-genuitec-file-id="wc1-8" data-genuitec-path="/SearchServer/WebRoot/index.jsp">
		...
		<div class="wrap flex-container">
			...
			<div class="bigContainer">
				...
				<div>
					...
					<div id="ten" style="display: none;" class="flex-item area pt-page-rotateUnfoldLeft"></div>
					<div id="nine" class="flex-item area pt-page-rotateUnfoldLeft"></div>
				</div>
			</div>
		</div>
	</div>
